...
class Rectangle {
     ...
     */
    constructor (gl, width, height, length, subDiv, col1, col2, col3) {
        ...
        this.vex = [
            vec3.fromValues(-length / 2, -width / 2, +height / 2),  // 0
            vec3.fromValues(+length / 2, -width / 2, +height / 2),  // 1
            vec3.fromValues(+length / 2, +width / 2, +height / 2),  // 2
            vec3.fromValues(-length / 2, +width / 2, +height / 2),  // 3
            vec3.fromValues(-length / 2, -width / 2, -height / 2),  // 4
            vec3.fromValues(+length / 2, -width / 2, -height / 2),  // 5
            vec3.fromValues(+length / 2, +width / 2, -height / 2),  // 6
            vec3.fromValues(-length / 2, +width / 2, -height / 2)   // 7
        ];
